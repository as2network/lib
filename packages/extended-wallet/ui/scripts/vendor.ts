...
import { recursiveDirectoryCopy } from '@as2network/file-copier'

const dependencyPaths = [
	[ '@as2network/recoverable-wallet-library', 'output', 'index.js' ],
	[ '@as2network/ethereum-abi-encoder', 'output-es', 'index.js' ],
	[ '@as2network/ethereum-crypto', 'output-es', 'index.js' ],
	[ '@as2network/ethereum-fetch-json-rpc', 'output-es', 'index.js' ],
	[ '@as2network/ethereum-types', 'output-es', 'index.js' ],
